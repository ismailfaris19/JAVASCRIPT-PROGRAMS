...
// let slicedNumebers = numbers.splice(3,10);
// console.log(numbers);
...
// let greaterThan8000 = players.filter(plr => (plr.runs > 8000 && plr.runs < 9000)) ;
...
flatArr = flatArr.flat(4);
// console.log(flatArr); // [1, 2, 3, 4, 5, 6, 7, 8]

// slice() - brief definition:
let sliceArr = [1, 2, 3, 4, 5];
let sliceStr = 'ismail';
// let slicedNumber = sliceArr.slice();
// let slicedNumber = sliceArr.slice(2, 4);
// let slicedNumber = sliceArr.slice(2);
// let slicedNumber = sliceArr.slice(2, -1);
// let slicedChar = sliceStr.slice(0);
// let slicedChar = sliceStr.slice(0, sliceStr.length);
// console.log(slicedNumber);
// console.log(slicedChar);


// every() - all the values in an array should meet the condition:
let everyNum = numbers.every(item => item >= 5);
